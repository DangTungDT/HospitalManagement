...
namespace GUI
{
    public partial class Form_Depment : Form
    {
        public Form_Depment()
        {
            InitializeComponent();
        }
        DepmentBLL blldpm = new DepmentBLL();
        DepmentDTO dtodpm = new DepmentDTO();

        private void Form_Depment_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            blldpm.ThemDepartment(new DepmentDTO(txtIdDepartment.Text, txtDepartmentName.Text, txtDescription.Text));
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            blldpm.CapnhatDepartment(new DepmentDTO(txtIdDepartment.Text, txtDepartmentName.Text, txtDescription.Text));
            dgv_phongban.DataSource = blldpm.HienThi();
        }
        ...
        private void Form_Depment_FormClosing(object sender, FormClosingEventArgs e)
        {
