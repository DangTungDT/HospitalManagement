...
namespace GUI
{
    public partial class frmMedicalRegistrationGUI : Form
    {
        public frmMedicalRegistrationGUI()
        {
            InitializeComponent();
        }

        private void frmMedicalRegistrationGUI_Load(object sender, EventArgs e)
        {
            StyleDataGridView(dgvaskAssignment);
        }
