...
namespace GUI
{
    public partial class Form_Room : Form
    {
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            // Lấy ID từ DataGridView (giả sử ID nằm ở cột đầu tiên hoặc cột có tên "id")
            if (dgv_phong.CurrentRow == null)
            {
            ...
            RoomDTO room = new RoomDTO
            {
                ID1 = Convert.ToInt32(dgv_phong.CurrentRow.Cells["id"].Value), // Adjust column name as needed
                RoomName = txtNameRoom.Text.Trim(),
                BedCount = bedCount,
                DepartmentID = cbo_bophan.SelectedValue.ToString() // Ensure type matches database
            };
        ...
        private void Form_Room_FormClosing(object sender, FormClosingEventArgs e)
        {
