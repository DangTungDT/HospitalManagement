...
namespace GUI
{
    public partial class Form_Invt : Form
    {
        public Form_Invt()
        {
            InitializeComponent();
        }
        InvtBLL ivtbll = new InvtBLL();
        InvtDTO ivtdto = new InvtDTO();
        ItemBLL itbll = new ItemBLL();
        private void Form_Invt_Load(object sender, EventArgs e)
        {
        ...
        {
            ivtbll.ThemInventory(new InvtDTO(txt_iditem.Text,
        ...
        {
            ivtbll.CapnhatInventory(new InvtDTO(txt_iditem.Text,
